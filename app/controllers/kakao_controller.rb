class KakaoController < ApplicationController
  ...
  def message
    ...
    if user_message == "꽃다발"
      image = true
      return_text = "꽃다발을 추천해드립니다.여기에서 자세히 확인하세요." + "https://mayflower3113.herokuapp.com"
      ...
      return_text = "화분을 추천해드립니다.여기에서 자세히 확인하세요." + "https://mayflower3113.herokuapp.com"
      ...
      return_text = "꽃다구니를 추천해드립니다.여기에서 자세히 확인하세요." + "https://mayflower3113.herokuapp.com"
      ...
      return_text = "조화를 추천해드립니다.여기에서 자세히 확인하세요." + "https://mayflower3113.herokuapp.com"
